...
// //   function changehere() {
// //     if (i < likec) {
// //       let like = document.querySelector('.scaffold-finite-scroll__content')
...
// //     if (k < commentc) {
// //       let commentbtn = document.querySelector('.scaffold-finite-scroll__content')
// //         .querySelectorAll('div.comment span div button')[k];
// //       if (commentbtn) commentbtn.click();

// //       let comment = document.querySelector('.scaffold-finite-scroll__content')
// //         .querySelectorAll('div.feed-shared-update-v2__comments-container .comments-comment-box .comments-comment-box__form-container .comments-comment-texteditor')[k];
// //       if (comment) comment.innerHTML = "CFBR";

// //       let post = document.querySelector('.scaffold-finite-scroll__content')
...
// // })(); // ✅ Now this closing matches the IIFE at the start
